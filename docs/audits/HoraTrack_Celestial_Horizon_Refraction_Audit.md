...
Ces 50 minutes d'arc correspondent approximativement à 34' de réfraction atmosphérique moyenne à l'horizon et 16' de demi-diamètre solaire apparent.

## Correction V2

### Réfraction séparée de l'éphéméride
...
- un astre légèrement sous l'horizon géométrique peut encore apparaître au bord du cadran dans la fenêtre standard de lever/coucher.

### Cas de la Lune

La définition précise du lever/coucher lunaire combine réfraction, demi-diamètre apparent et parallaxe. Comme `CelestialEngineV2` corrige déjà la Lune en topocentrique, l'essentiel de la parallaxe est déjà retiré avant le rendu. Le seuil pratique du centre devient donc voisin de `-(34' + demi-diamètre lunaire)`.

Le demi-diamètre de la Lune varie légèrement avec sa distance. La constante commune voisine de `-0,83°` est conservée pour ce moteur léger afin de ne pas afficher une fausse précision supérieure à celle de l'éphéméride elle-même.
