...
final class SalarySegmentedWorkedVariableGrossSourceV2Tests: XCTestCase {
    func testFullTimeMondaySegmentsProduceOnlyVariableOvertime() throws {
        ...
        XCTAssertEqual(result.breakdowns[0].variableOvertimeMinutes, 300)
        XCTAssertEqual(result.breakdowns[0].complementaryGross, 0, accuracy: 0)
        XCTAssertEqual(result.breakdowns[0].complementaryMinutes, 0)
        ...
        XCTAssertEqual(result.breakdowns[1].variableOvertimeMinutes, 300)
        XCTAssertEqual(result.breakdowns[1].complementaryGross, 0, accuracy: 0)
        XCTAssertEqual(result.breakdowns[1].complementaryMinutes, 0)
