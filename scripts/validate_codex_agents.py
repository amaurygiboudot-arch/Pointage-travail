...
expected = {
    ...
    "security_privacy": "agents/security-privacy.toml",
    "performance_battery": "agents/performance-battery.toml",
    "release_store": "agents/release-store.toml",
    "analytics_data": "agents/analytics-data.toml",
