...
object DeveloperDiamondLivePanel {
    ...
    private fun specs() = listOf(
        ...
        Spec("EFFETS", "Arc Soleil / bande blanche", "sunArcAlpha", 0f, 255f, 0) { it.sunArcAlpha },
        Spec("EFFETS", "Arc Lune / bande blanche", "moonArcAlpha", 0f, 255f, 0) { it.moonArcAlpha },
        Spec("EFFETS", "Épaisseur bande", "arcWidth", .002f, .10f, 3) { it.arcWidth },
        Spec("EFFETS", "Longueur bande (°)", "arcSpanDeg", 0f, 180f, 0) { it.arcSpanDeg },
        Spec("EFFETS", "Rayon / position bande", "arcRadius", .55f, 1.10f, 3) { it.arcRadius },
        Spec("EFFETS", "Rotation bande (°)", "arcAngleOffsetDeg", -180f, 180f, 0) { it.arcAngleOffsetDeg },
