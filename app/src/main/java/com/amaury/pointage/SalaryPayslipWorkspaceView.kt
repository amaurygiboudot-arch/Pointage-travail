  ...
  if(calc==null){add(TextView(context).apply{text="Calcul détaillé indisponible : complète le contrat et la convention de cette entreprise. HoraTrack n’invente aucune majoration.";textSize=14f})}else{
   ...
   val lines=buildString{
    ...
    if(calc.paidTimeReliable){
     ...
     append("Heures normales : À confirmer\n");append("Heures supplémentaires / complémentaires : À confirmer\n");append("Heures de nuit : À confirmer\n");append("Samedi : À confirmer\n");append("Dimanche : À confirmer\n")
    }
