...
object CelestialScreenGeometryV2 {
    /** Marge verticale nécessaire au cadran et aux disques Soleil/Lune. */
    ...
    /**
     * Dimension de référence qui garde le rendu dans le panneau, même lorsque
     * la largeur est très supérieure à la hauteur (paysage, tablette, fenêtre).
     */
