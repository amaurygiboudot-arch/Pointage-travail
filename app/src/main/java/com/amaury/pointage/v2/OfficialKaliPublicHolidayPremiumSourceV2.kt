...
/** Recherche KALI large sur les jours fériés ; le parseur décide ensuite si la règle est exploitable. */
object OfficialKaliPublicHolidayPremiumSourceV2 {
