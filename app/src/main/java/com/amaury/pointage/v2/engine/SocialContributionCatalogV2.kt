...
object SocialContributionCatalogV2 {
    ...
    private val rules2026 = listOf(
        ...
        Rule("employer_csa", "Contribution solidarité autonomie", 0.0, Base.GROSS, 2026, 2026, "Urssaf - taux secteur privé 2026", employerRate = 0.0030),
        Rule("employer_social_dialogue", "Contribution au dialogue social", 0.0, Base.GROSS, 2026, 2026, "Urssaf - taux secteur privé 2026", employerRate = 0.00016),
