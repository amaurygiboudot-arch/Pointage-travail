...
object CompanyHealthFamilyStoreV2 {
    ...
    internal fun companyUnavailableResult(): ReadResult = ReadResult(
        emptyList(),
        false,
        listOf("Maladie/allocations familiales employeur : entreprise absente ou stockage des entreprises non fiable.")
    )
    ...
    private fun writeConfirmed(context: Context, companyId: String, items: List<EmployerHealthFamilyV2.Record>): Boolean {
        val array = JSONArray()
