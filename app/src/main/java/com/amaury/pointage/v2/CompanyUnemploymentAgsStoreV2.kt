...
object CompanyUnemploymentAgsStoreV2 {
    ...
    internal fun companyUnavailableResult(): ReadResult = ReadResult(
        emptyList(),
        false,
        listOf("Chômage/AGS employeur : entreprise absente ou stockage des entreprises non fiable.")
    )
    ...
    private fun writeConfirmed(context: Context, companyId: String, items: List<EmployerUnemploymentAgsV2.Record>): Boolean {
        val array = JSONArray()
